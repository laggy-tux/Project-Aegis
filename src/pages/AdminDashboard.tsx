        ...
        return (
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="text-3xl font-bold text-gray-800">560</div>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex flex-col md:hidden">
        ...
        <div className="text-center px-4">
          ...
          <h2 className="text-sm text-gray-400 font-light mb-6">Dashboard Interface</h2>
        </div>
                ...
                <ScrollArea className="h-full">
                  <div className="p-4 pt-8 pb-16">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      >
                        <div className="text-black text-2xl font-bold mb-1">560</div>
                      ...
                      <button
                        ...
                        className="bg-white p-3 rounded-lg text-left hover:shadow-md transition-all duration-200 hover:scale-105 border border-gray-100"
                      >
                        <div className="text-blue-600 text-2xl font-bold mb-1">340</div>
